...
import { Loader2, User, Mail, Phone, Calendar, Shield, Building } from 'lucide-react';
                    ...
                    <CardContent className="space-y-4">
                        ...
                        {profile?.organization && (
                            <div className="rounded-lg border p-3 space-y-2">
                                ...
                                <Badge variant={
                                    profile.organization.status === 'APPROVED' ? 'default' :
                                        profile.organization.status === 'PENDING' ? 'secondary' :
                                            'destructive'
                                }>
